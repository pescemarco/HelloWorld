...
learning as manyy things as possible

about live, humans, what the world is made of
...
sono sempre i sogni a fare la realtà (L. Ligabue)

...quelle rughe sono solo

i tentativi che non hai mai fatto (L. Ligabue)

Ritroveremo

un altro sogno in un cassetto

arreso

senza chiederci perché

ieri c'era e oggi non c'è (F. Gabbani)

## Bio

I was born on April 25th 1974.

When I was a kid, my father gave me and my bro a computer. It was a Commodore64, featuring 64kB RAM (of which about 38kB) available for the user's programs), a datassete tape recorder to save and load programs, a RF TV output connector, plus a parallel port, a cartridge slot and a pair of dsub-9 connector to mate a couple of joystick. How many fun hours we had
It came with a programmer's manual explaining in a certain details its BASIC v2 language. And many other funhours came from here.